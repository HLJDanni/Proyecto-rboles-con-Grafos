...
import java.util.LinkedList; /*La clase LinkedList implementa la
lógica para trabajar con listas genéricas, es decir podemos insertar y 
extraer elementos de cualquier parte de la lista. Confeccionaremos un 
programa para llamar los principales métodos de esta clase.
*/
...
public class ArbolBB {
    ...
    public void insertar(Nodo nuevo, Nodo pivote) {
        if (this.raiz == null) {
            ...
            if (nuevo.getDato().compareTo(pivote.getDato())<0){
    ...
    public boolean existe(String dato) {
        Nodo aux = raiz;
        while (aux != null) {
            if (dato == null ? aux.getDato() == null : dato.equals(aux.getDato())) {
                return true;
